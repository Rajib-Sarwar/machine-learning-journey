...
GitHub's native notebook renderer sometimes struggles to display complex HTML formatting. For the best experience, please choose one of the options below:
...
> **Read-Only:** Best for simply reading the notebook with perfect formatting and working dropdown hints.
...
> **Interactive:** Best if you want to execute the code, experiment, and interact with the notebook directly in your browser.
