...
```
    ...
    Cost after iteration 20000: 0.13851642423266738
...
def compute_cost_with_regularization(A3, Y, parameters, lambd):
    ...
    ### START CODE HERE ###
    WL = np.sum(np.square(W1)) + np.sum(np.square(W2)) + np.sum(np.square(W3))
    L2_regularization_cost = (1/2) * (lambd/m) * WL
